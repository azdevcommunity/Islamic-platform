      ...
      <div className="max-w-md w-full text-center">
        ...
        <div className="mb-8">
          <div className="relative mx-auto w-48 h-48 mb-6">
            ...
            <div
              className="absolute inset-4 bg-gradient-to-br from-red-200 to-red-300 rounded-full opacity-30 animate-pulse"
              style={{ animationDelay: "0.2s" }}
            ></div>
            <div
              className="absolute inset-8 bg-gradient-to-br from-red-300 to-red-400 rounded-full opacity-40 animate-pulse"
        ...
        <div className="space-y-4 mb-8">
          ...
          <p className="text-gray-600 text-lg leading-relaxed">
            Təəssüf ki, səhifə yüklənərkən xəta baş verdi. Zəhmət olmasa
            yenidən cəhd edin.
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg p-6 shadow-sm border border-red-200 mb-8">
          ...
          <div className="text-left">
            ...
            {error?.message &&
              process.env.APP_ENV_NODE_ENV === "development" && (
                <p className="text-sm text-gray-600 mb-2">
                  <strong>Mesaj:</strong> {error.message}
                </p>
              )}
            <p className="text-xs text-gray-500">
              Bu xəta brauzer tərəfində baş verib və avtomatik olaraq qeydə
              alınıb.
            </p>
          </div>
        </div>
