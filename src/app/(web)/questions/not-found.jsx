      ...
      <div className="max-w-2xl w-full text-center">
        ...
        <div className="mb-12">
          <div className="relative mx-auto w-40 h-40 mb-8">
            <div className="absolute inset-0 bg-gradient-to-br from-blue-100 to-blue-200 rounded-3xl opacity-20 transform rotate-12 animate-pulse"></div>
            <div className="absolute inset-2 bg-gradient-to-br from-blue-200 to-blue-300 rounded-3xl opacity-30 transform rotate-6"></div>
            <div className="absolute inset-4 bg-gradient-to-br from-blue-300 to-blue-400 rounded-3xl opacity-40"></div>
        ...
        <div className="space-y-6">
          <Link 
            href="/questions/ask"
            className="inline-flex items-center justify-center gap-3 w-full px-8 py-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold rounded-xl hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
          >
            <FaPlus />
            Yeni Sual Ver
          </Link>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Link 
              href="/questions"
              className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-white text-blue-600 border-2 border-blue-600 rounded-xl hover:bg-blue-50 transition-all duration-300 font-semibold"
            >
              <FaList />
              Bütün Suallar
            </Link>
