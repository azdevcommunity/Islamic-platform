...
interface ModernCardProps {
  ...
  info1Label: string;
  info1: string;
  info1Icon: React.ComponentType<any>;
  info2Label?: string;
  info2?: string;
  info2Icon?: React.ComponentType<any>;
  animationDelay?: number;
}

function ModernCard({ href, image, title, info1Label, info1, info1Icon: Info1Icon, info2Label, info2, info2Icon: Info2Icon, animationDelay = 0 }: ModernCardProps) {
  return (
      <Link
        href={href}
