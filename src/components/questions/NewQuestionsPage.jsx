            ...
            >
                <div className="p-8">
                    <div className="flex items-start gap-6">
                        {/* Question Icon */}
                        <div
                            className="flex-shrink-0 w-12 h-12 bg-gradient-to-br from-green-500 to-green-600 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
        ...
        >
            ...
            <div className="p-4 sm:p-6 pb-3 sm:pb-4">
                <div className="flex items-start gap-3 sm:gap-4 mb-3 sm:mb-4">
                    <div
                        className="flex-shrink-0 w-10 h-10 bg-gradient-to-br from-green-500 to-green-600 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
            ...
            <div className="px-4 sm:px-6 pb-3 sm:pb-4">
                <div className="flex flex-wrap gap-2">
                    ...
                    {question.categories?.length > 2 && (
                        <span
                            className="inline-flex items-center px-2.5 py-1 bg-gray-50 text-gray-600 text-xs font-medium rounded-lg">
                            +{question.categories.length - 2}
                        </span>
                    )}
                </div>
...
const ModernHeader = ({
    ...
    return (
        <div
            className="bg-white rounded-lg sm:rounded-2xl border border-gray-100 shadow-sm p-4 sm:p-8 mb-4 sm:mb-8 mx-1 sm:mx-0">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                ...
                <div className="space-y-2">
                    ...
                    <p className="text-gray-600 flex items-center gap-2">
                        <span
                            className="inline-flex items-center gap-1.5 px-3 py-1 bg-green-50 text-green-700 text-sm font-medium rounded-lg">
...
const SkeletonLoader = ({layout, count = 6}) => {
    const skeletonItems = Array.from({length: count}).map((_, index) => (
        <div key={index}
             className={`bg-white rounded-lg sm:rounded-2xl border border-gray-100 animate-pulse ${layout === 'grid' ? 'min-h-[420px] flex flex-col' : ''
             }`}>
            {layout === 'grid' ? (
                <>
...
export default function NewQuestionsPage({statistics}) {
    ...
    return (
        <main className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-green-50/30">
            {/* Hero Section */}
            <section
                className="relative py-20 md:py-28 bg-gradient-to-br from-[#43b365] via-[#2d7a47] to-[#1e5a32] overflow-hidden">
                {/* Background Pattern */}
                    ...
                    <div className="text-center space-y-8">
                        ...
                        >
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight">
                                Dini Suallar və
                                <span
                                    className="block text-transparent bg-gradient-to-r from-yellow-200 to-yellow-400 bg-clip-text">
                                    Mütəxəssis Cavabları
                                </span>
                            </h1>
                            <p className="text-xl md:text-2xl text-white/80 max-w-3xl mx-auto leading-relaxed">
                                İslami elm və hikmətdən doğan suallarınızın cavablarını tapın və mənəvi inkişafınıza
                                töhfə verin
                            </p>
                        </motion.div>
                        ...
                        >
                            {[
                                ...
                                {
                                    label: "Oxunma",
                                    count: statistics.totalViewCount > 1000 ? `${Math.floor(statistics.totalViewCount / 1000)}K+` : `${statistics.totalViewCount}+`
                                }
                            ].map((stat, index) => (
                                <div
                                    key={index}
