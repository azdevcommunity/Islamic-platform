...
import {
    ...
    CompactQuestionsSkeletonLoader
} from "./CompactQuestionsList";
import { NoQuestionsFound, OptimizedPagination } from "./QuestionComponents";

export default function CompactQuestionsPage() {
    // State Management
    ...
    }, [page, filters.searchQuery, filters.categories, filters.tags, sortBy]);
    ...
    return (
        <main className="min-h-screen bg-gray-50">
            ...
            <section className="relative py-20 md:py-28 bg-gradient-to-br from-[#43b365] via-[#2d7a47] to-[#1e5a32] overflow-hidden">
                ...
                <div className="container mx-auto px-4 max-w-7xl relative">
                    ...
                    >
                        ...
                        >
                            {[
                                { label: "Suallar", count: questions.length || "200+" },
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8">
                            <a
                                href="/questions/ask"
                                className="inline-flex items-center justify-center px-8 py-4 bg-white text-[#43b365] font-semibold rounded-xl hover:bg-gray-50 transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105"
                            >
                                Sual Ver
                            </a>
                            <a
            ...
            {/* Main Content */}
            <section id="content" className="py-12 md:py-16">
                        ...
                        <AnimatePresence mode="wait">
                            {error && (
                                <motion.div
                                    ...
                                    className="my-6 p-4 bg-red-50 border border-red-200 text-red-700 rounded-xl text-center"
                                >
                            ...
                            {loading ? (
                                ...
                                >
                                    <CompactQuestionsGrid questions={questions} />
