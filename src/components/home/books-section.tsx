 ...
 * Displays book carousel on the home page
 */
...
export function BooksSection() {
  return (
    <Container className="relative">
      <SectionHeader
        badge="Kitablarımız"
        title="Ruhani Sərvətlər"
        description="İslami elm və mənəviyyatın dərin mənbələrindən hazırlanmış kitablarımız"
      />
      ...
      <div className="relative">
        ...
        {/* Pagination */}
        <div className="books-pagination flex justify-center space-x-2 mt-8" />
      </div>
