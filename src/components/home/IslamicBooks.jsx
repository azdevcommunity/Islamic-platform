        ...
        <>
            ...
            <div className="container mx-auto px-4 max-w-7xl relative">
                <div className="text-center mb-16">
                    <div
                        className="inline-flex items-center gap-2 px-4 py-2 bg-accent-50 rounded-full text-accent-700 font-medium text-sm mb-4 border border-accent-100">
                    ...
                    <div
                        className="mt-8 w-24 h-0.5 bg-gradient-to-r from-accent-400 to-accent-600 mx-auto rounded-full"></div>
                </div>
                        ...
                        {booksData.map((book) => (
                            <SwiperSlide key={book.id} className="!flex justify-center">
                                ...
                                <div className="group flex w-full max-w-[280px] flex-col items-center text-center">
                                    <div
                                        className="relative aspect-[3/4] w-full overflow-hidden rounded-2xl shadow-md transition-all duration-500 group-hover:-translate-y-2 group-hover:shadow-xl border-2 border-stone-100 group-hover:border-primary-200">
                                        <Image
                                            src={book.image}
                                            alt={book.title}
                                            fill
                                        ...
                                        <div
                                            className="absolute inset-0 bg-gradient-to-t from-stone-900/40 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>

                                        {/* Qiymət badge - Minimal */}
                                        <div
                                            className="absolute top-4 right-4 px-3 py-1.5 bg-accent-500 text-white text-sm font-semibold rounded-full shadow-md">
                                            {book.price}
                                        </div>

                                        {/* Kateqoriya badge */}
                                        <div
                                            className="absolute top-4 left-4 px-3 py-1 bg-white/95 backdrop-blur-sm text-stone-700 text-xs font-medium rounded-full border border-stone-200">
                                            {book.category}
                                        </div>
