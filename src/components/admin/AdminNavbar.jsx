...
import { LogOut, User, Settings, LayoutDashboard, RefreshCw, Menu, X, Bell, Search } from 'lucide-react'
...
const AdminNavbar = ({
  ...
  return (
    <nav className="fixed top-0 z-50 w-full bg-white/95 backdrop-blur-2xl border-b border-slate-200/60 shadow-lg shadow-slate-200/20">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center justify-start rtl:justify-end">
            ...
            <Button
              ...
              className="inline-flex items-center p-2.5 text-sm sm:hidden hover:bg-slate-100/80 rounded-xl transition-all duration-200 hover:scale-105"
            >
          ...
          <div className="flex items-center space-x-1">
            ...
            <Button
              variant="ghost"
              size="sm"
              className="h-10 w-10 rounded-xl hover:bg-slate-100/80 transition-all duration-200 hover:scale-105"
            >
            ...
            <Button
              variant="ghost"
              size="sm"
              className="h-10 w-10 rounded-xl hover:bg-slate-100/80 transition-all duration-200 hover:scale-105 relative"
            >
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  ...
                  className="h-10 w-10 rounded-xl hover:bg-slate-100/80 transition-all duration-200 hover:scale-105 disabled:hover:scale-100"
                >
                  <RefreshCw className={`h-4 w-4 transition-colors ${isRefreshing ? 'animate-spin text-emerald-600' : 'text-slate-600'}`} />
                  <span className="sr-only">Refresh Options</span>
                </Button>
              </DropdownMenuTrigger>
              <DropdownMenuContent align="end" className="w-52 border-slate-200/60 shadow-xl">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" size="sm" className="relative h-10 w-10 rounded-xl hover:bg-slate-100/80 transition-all duration-200 hover:scale-105 ml-2">
              ...
              <DropdownMenuContent align="end" className="w-72 border-slate-200/60 shadow-xl">
                <DropdownMenuLabel className="font-normal p-0">
                  <div className="flex items-center gap-4 p-4 bg-gradient-to-r from-emerald-50/50 to-emerald-100/50 rounded-t-lg">
                ...
                <div className="p-2">
                  <DropdownMenuItem onClick={onLogout} className="flex items-center gap-3 text-red-600 focus:text-red-600 py-2.5 px-3 rounded-lg">
