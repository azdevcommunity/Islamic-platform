...
export default function ContactForm() {
    ...
    const [submitStatus, setSubmitStatus] = useState<SubmitStatus>({status: null, message: ''});
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            // API endpointinə apiClient ilə sorğu göndəririk
            await apiClient.post("/contact", formData);
            
            // Uğurlu cavab halında (apiClient throws on error)
            ...
            const errorMessage = error.message || 'Mesaj göndərilərkən xəta baş verdi. Zəhmət olmasa, yenidən cəhd edin.';
